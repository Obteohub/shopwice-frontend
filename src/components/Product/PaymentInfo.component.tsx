            ...
            <div>
                <div className="flex items-center gap-1">
                    <div className="text-xs text-gray-700 ">
                        Payment: Pay On Delivery, Pay With MOMO, Pay Online With VISA, Mastercard, Bank Transfer, Cheque Payment. 
                    </div>
                    <button
                        ...
                        <div className="px-6 py-5 space-y-4">
                            ...
                            <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-4">
                                <p className="text-xs text-yellow-900 leading-relaxed">
                                    <strong>Payment on delivery note:</strong> Payment on delivery is available for eligible Greater Accra orders only. Orders outside Accra do not qualify for payment on delivery and must be paid for before dispatch.
                                </p>
                            </div>
